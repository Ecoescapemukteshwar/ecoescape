...
export const blogComponents = {
  ...
  'mukteshwar-distance-from-major-cities': lazy(() => import('./MukteshwarDistanceGuide')),
  'mukteshwar-vs-garhmukteshwar': lazy(() => import('./MukteshwarVsGarhmukteshwar')),
  'bhimtal-to-mukteshwar-route-guide': lazy(() => import('./BhimtalToMukteshwarRoute')),
  'kathgodam-to-mukteshwar-route-guide': lazy(() => import('./KathgodamToMukteshwarRoute')),
  // 2026-05 trends-driven batch (CSV: searched_with_top-queries_IN_20260403-1607_20260503-1607)
  'mukteshwar-temperature-today-and-monthly-guide': lazy(() => import('./MukteshwarTemperatureToday')),
  'mukteshwar-vs-mussoorie': lazy(() => import('./MukteshwarVsMussoorie')),
  'mukteshwar-vs-almora-vs-ranikhet': lazy(() => import('./MukteshwarVsAlmoraVsRanikhet')),
  'mukteshwar-uttarakhand-travel-guide': lazy(() => import('./MukteshwarUttarakhandTravelGuide')),
  'mukteshwar-mahadev-mandir-darshan-timings': lazy(() => import('./MukteshwarMahadevDarshanTimings')),
  'mukteshwar-3-day-2-night-itinerary': lazy(() => import('./ThreeDayItinerary')),
  'nainital-to-mukteshwar-distance': lazy(() => import('./NainitalToMukteshwarDistance')),
  'mukteshwar-honeymoon-guide': lazy(() => import('./HoneymoonGuide')),
  'places-to-visit-near-mukteshwar-within-50km': lazy(() => import('./PlacesNearMukteshwar50km')),
  'mukteshwar-airbnb-vs-homestay-direct-booking': lazy(() => import('./AirbnbVsHomestayDirect')),
  'pantnagar-airport-to-mukteshwar': lazy(() => import('./PantnagarAirportToMukteshwar')),
  'is-mukteshwar-worth-visiting': lazy(() => import('./IsMukteshwarWorthVisiting')),
  'mukteshwar-resort-vs-homestay-comparison': lazy(() => import('./ResortVsHomestayComparison')),
  'mukteshwar-vs-shimla': lazy(() => import('./MukteshwarVsShimla')),
  'lucknow-to-mukteshwar-road-guide': lazy(() => import('./LucknowToMukteshwar')),
  // 2026-05 expansion batch — month-specific, persona, route, origin
  'mukteshwar-in-march': lazy(() => import('./MukteshwarInMarch')),
  'mukteshwar-in-may': lazy(() => import('./MukteshwarInMay')),
  'mukteshwar-in-june': lazy(() => import('./MukteshwarInJune')),
  'mukteshwar-in-october': lazy(() => import('./MukteshwarInOctober')),
  'mukteshwar-with-kids': lazy(() => import('./MukteshwarWithKids')),
  'mukteshwar-group-trip-guide': lazy(() => import('./MukteshwarGroupTrip')),
  'mukteshwar-pre-wedding-shoot-guide': lazy(() => import('./MukteshwarPreWeddingShoot')),
  'mukteshwar-adventure-activities-guide': lazy(() => import('./MukteshwarAdventureActivities')),
  'mukteshwar-to-almora-route-guide': lazy(() => import('./MukteshwarToAlmoraRoute')),
