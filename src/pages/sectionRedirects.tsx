...
export const RoomsRedirect = () => <Navigate to="/#rooms" replace />;
export const DiningRedirect = () => <Navigate to="/#dining" replace />;
export const GardenRedirect = () => <Navigate to="/#garden" replace />;
