...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "mukteshwar-in-february",
    title: "Mukteshwar in February: Late Snow & Travel Guide (2026)",
    excerpt: "February in Mukteshwar — the tail of the snow season with strong early-month odds, crisp 6–13°C days, the clearest Himalayan views, and quiet, great-value weeks.",
    date: "June 4, 2026",
    readTime: "5 min read",
    image: blogImg("winter-experience/featured.webp"),
    imageAlt: "Crisp late-winter morning in Mukteshwar with snow on the Himalayan peaks in February",
    category: "Seasonal Guide",
  },
  {
    slug: "mukteshwar-in-july",
    title: "Mukteshwar in July: Monsoon Mist & Travel Guide (2026)",
    excerpt: "July in Mukteshwar — atmospheric monsoon mist, the lushest green of the year, full waterfalls, lowest crowds and best value. Honest take on rain, roads and packing.",
    date: "June 4, 2026",
    readTime: "5 min read",
    image: blogImg("monsoon/featured.webp"),
    imageAlt: "Monsoon mist rolling over the lush green hills of Mukteshwar in July",
    category: "Seasonal Guide",
  },
  {
    slug: "mukteshwar-in-august",
    title: "Mukteshwar in August: Monsoon & Independence Day Guide (2026)",
    excerpt: "August in Mukteshwar — peak monsoon greenery, full waterfalls, low crowds, and the popular Independence Day long-weekend escape. Weather, packing and booking tips.",
    date: "June 4, 2026",
    readTime: "5 min read",
    image: blogImg("monsoon/featured.webp"),
    imageAlt: "Lush, mist-wrapped green hills of Mukteshwar during the August monsoon",
    category: "Seasonal Guide",
  },
  {
    slug: "mukteshwar-in-september",
    title: "Mukteshwar in September: Monsoon's End & Travel Guide (2026)",
    excerpt: "September in Mukteshwar — lush post-monsoon green, clearing Himalayan views late month, full waterfalls, low crowds and great value. The underrated start of autumn.",
    date: "June 4, 2026",
    readTime: "5 min read",
    image: blogImg("best-time-to-visit/featured.webp"),
    imageAlt: "Lush green Mukteshwar hills with clearing post-monsoon skies in late September",
    category: "Seasonal Guide",
  },
  {
    slug: "mukteshwar-in-november",
    title: "Mukteshwar in November: Crisp Clear Days & Travel Guide (2026)",
    excerpt: "November in Mukteshwar — crisp, dry autumn days (12–18°C), sharp Himalayan views, golden light, bonfire evenings, and low crowds outside Diwali week.",
    date: "June 4, 2026",
    readTime: "5 min read",
    image: blogImg("photography/featured.webp"),
    imageAlt: "Crisp clear November morning in Mukteshwar with sharp views of the Himalayan range",
    category: "Seasonal Guide",
  },
];
